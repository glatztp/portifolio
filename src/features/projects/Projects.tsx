...
const PROJECTS = [
  {
    num: "01",
    title: "Merge Conflit",
    sub: "Site de Diversão para Devs",
    tech: ["React", "Node.js", "SQL", "REST API"],
    desc: "Site onde você luta com algum usando seu github stats para calcular os golpes. Feito para diversão e aprendizado de APIs.",
    year: "2025",
    link: "merge-conflict-six.vercel.app",
    colorA: "#a07ed4",
    colorB: "#6b3fa0",
  },
  {
    num: "02",
    title: "Glacien",
    sub: "React Component Library",
    tech: ["React", "TypeScript", "Recharts", "Node.js"],
    desc: "Biblioteca de componentes React moderna, acessível e customizável",
    year: "2025",
    link: "glacien.online",
    colorA: "#4fa8d4",
    colorB: "#1a5c8a",
  },
  {
    ...
    desc: "Experimento de detecção de gestos usando a webcam, com visualização em tempo real e feedback interativo.",
    year: "2024",
    link: "https://github.com/glatztp/gesture-detection",
    colorA: "#d47e4f",
    colorB: "#8a3a1a",
  },
  // {
